...
if __name__ == "__main__":
    ...
    for seed in random_seed:
        ...
        latent, pred = scClustering.pretrain(X, count_X, size_factor, args.batch_size, args.pretrain_epoch, args.gpu_option)

        # embedding = scClustering.get_embedding(latent)
        # scClustering.draw_umap(embedding, Y)
        scClustering.tsne_plot(latent, Y, pred, args.dataname,seed)
